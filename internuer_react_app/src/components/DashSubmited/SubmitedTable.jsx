...
const SubmitedTable = ({ selectAll, rowFunction, changePlayIcon, openInterviews, handleClickOpenPop }) => {
                    ...
                    {[...Array(20)].map((x, i) =>
                        <tr className={D1table.dTableBody} key={i} id={`tr${i}`}>
                            ...
                            <td className={D1table.interviewTime} onClick={() => rowFunction(i)}    >
                                <img src={PlayNew} alt="" id={`icon${i}`} className={D1table.Playbtn} onClick={() => { changePlayIcon(i); handleClickOpenPop(i); }} />
                            </td>
